...
The graph shows Debt to GDP ration for each countries from the year 1998 to 2018. To view the exact value of debt to gdp ration , hover on the brown lines.
...
Hover on each year. Click on each year box's borders to get accurate figures of the debt to gdp ration of each country
